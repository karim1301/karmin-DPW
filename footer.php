...
<div id="footer-bottom">
	<div class="container clearfix">
		...
		<p id="copyright"><?php esc_html_e('Designed by ','TheSource'); ?> <a href="http://www.about.me/KarimHmeidan">Karim Hmeidan</a> | <?php esc_html_e('Powered by ','TheSource'); ?> <a href="http://www.wordpress.org">Wordpress</a></p>
	</div> <!--end .container -->
